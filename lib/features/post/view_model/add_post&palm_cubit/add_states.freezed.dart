...
abstract class _Initial<T> implements AddPostStates<T> {
...
abstract class AddLoading<T> implements AddPostStates<T> {
...
class _$AddSuccessImpl<T> implements AddSuccess<T> {
  const _$AddSuccessImpl(this.data);
...
abstract class AddSuccess<T> implements AddPostStates<T> {
  const factory AddSuccess(final String data) = _$AddSuccessImpl<T>;
...
abstract class AddError<T> implements AddPostStates<T> {

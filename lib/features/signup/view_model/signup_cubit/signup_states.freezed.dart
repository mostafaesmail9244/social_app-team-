...
mixin _$SignupStates<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(UserCredential data) signupSuccess,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(UserCredential data)? signupSuccess,
...
abstract class SignupSuccess<T> implements SignupStates<T> {
  const factory SignupSuccess(final UserCredential data) =
...
class __$$SignupErrorImplCopyWithImpl<T, $Res>
    extends _$SignupStatesCopyWithImpl<T, $Res, _$SignupErrorImpl<T>>
...
class _$SignupErrorImpl<T> implements SignupError<T> {
  ...
  @override
  String toString() {
    return 'SignupStates<$T>.signupError(error: $error)';
  }
...
abstract class SignupError<T> implements SignupStates<T> {

...
class GetUserStates<T>with _$GetUserStates{
  ...
  const factory GetUserStates.getUserSuccess(UserResponse data)=GetuserSuccess<T>;
  const factory GetUserStates.getUserError({required String error})=GetUserError;
}